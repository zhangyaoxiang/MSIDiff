...
class ScorePosNet3D(nn.Module):
    ...
    def q_pos_posterior(self, x0, xt, t, batch, t_minus1=None, shift=None, shift_minus1=None):
    ...
    def sample_diffusion(self, protein_pos, protein_v, batch_protein,
        ...
        for i in tqdm(time_seq, desc='sampling', total=len(time_seq)):
            ...
            # pos_model_mean = self.q_pos_posterior(x0=pos0_from_e, xt=ligand_pos, t=t, batch=batch_ligand, t_minus1=t_minus1, shift=shift_cond_t, shift_minus1=shift_cond_t_minus1)
