...
#         halfedge_index = torch.triu_indices(n_atoms, n_atoms, offset=1) #获取上三角矩阵索引
#         halfedge_type = bond_matrix[halfedge_index[0], halfedge_index[1]] #获取半边形的边类型
#         data.ligand_fc_bond_index = halfedge_index#设置半边形索引和类型矩阵，并设置相应的属性
#         data.ligand_fc_bond_type = halfedge_type
#         return data
class FeaturizeLigandBond(object):
